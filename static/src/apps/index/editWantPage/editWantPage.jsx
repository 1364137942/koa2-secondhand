...
import styles from './editWantPage.cssmodule.less'
...
class App extends React.Component {
  constructor(props, context){
    ...
    this.url = '/wantsController/addWant';
    this.state = {
      loading: false,
      goodName: '',
      goodType: '',
  ...
  componentDidMount(){
    ...
    let wantID = document.getElementById('wantID').getAttribute('data-value');
    this.fillForm(wantID);
  }
  async fillForm(wantID){
    if(wantID !== ''){
      this.url = '/wantsController/modifyWant';
          ...
          <Form onSubmit={(e) => this.handleSubmit(e)} className="login-form">
            ...
            >
              {getFieldDecorator('goodType', {
                ...
                >
                  {this.renderGoodTypeList(goodTypeList)}
                </Select>
              )}
            </FormItem>
            <FormItem
